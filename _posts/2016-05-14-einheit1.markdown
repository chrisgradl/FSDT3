...
### Parse Error
In der Übung ist immer wieder ein Error aufgetreten beim Einlesen der Daten. Das lag an den angefangenen Zeilen die wir mit dem Arduino versendet haben. Hier ist es besser immer eine komplette Zeile zu senden.
