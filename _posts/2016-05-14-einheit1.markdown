...
Falls der Arduino aus irgendeinem Grund nicht verfügbar ist oder nicth funktioniert gibt es die Möglichkeit Random Daten vom Node Server zum Client zu schicken
