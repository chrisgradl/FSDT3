...
* add the following dependencies to the project with the --save flag
  * express
  * serialport: we have to install a specific version with this command: `npm install serialport@4.0.7 --save `
  * socketio
...
### Writing datapoints into a file:
