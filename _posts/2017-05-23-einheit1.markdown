...
- create a new dir with the name `asens2_task_0` at your Desktop (with the Command Line!!!)
...
For our first Node.js application create a new directory with the name: `asens2_task_1`. Switch to this directory and create a new index.js file. Write a simple output to the console
...
Create a new directory with the name: `asens2_task_2`. Switch to this directory and create a new index.js file.To start a http server you have to load the http module and call the `createServer` function.
...
- Create directory with name `asens2_task_4`
